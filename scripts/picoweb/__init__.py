...
class WebApp:
    ...
    def _handle(self, reader, writer):
        ...
        try:
            ...
            if found:
                ...
                yield from self.render_template(writer, "404.tpl", (req,))
    ...
    def run(self, host="127.0.0.1", port=8081, debug=False, lazy_init=False, log=None, event=None):
        ...
        loop.run_until_complete(asyncio.start_server(self._handle, host, port, event=event))
